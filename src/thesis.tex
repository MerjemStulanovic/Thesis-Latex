...
%%M Datum dole promijeni na datum kad predaš.
% Required data.
\setregnumber{882311}
...
%%M Ako kod vas ne treba ta izjava da si sama radila, ovu liniju obriši.
%    \addstatementpage
...
% Switch to arabic numbering and start the enumeration of chapters in the table of content.
    ...
    \input{content/1-introduction/0-intro.tex}
    \clearpage
    \input{content/1-introduction/1-motivation-goals.tex}
    \input{content/1-introduction/2-problem-statement.tex}
    \input{content/1-introduction/3-methodology-solution-approach.tex}
    \input{content/1-introduction/4-structure.tex}

    \chapter{Literature Review}\label{ch:literature-review}
    \input{content/2-literature-review/0-intro.tex}
    \input{content/2-literature-review/1-information-visualization.tex}
    \input{content/2-literature-review/2-temporal-visualization.tex}
    \input{content/2-literature-review/3-geospatial-visualization.tex}
    \input{content/2-literature-review/4-spatio-temporal-visualization.tex}
    \input{content/2-literature-review/5-space-time-cube.tex}
    \input{content/2-literature-review/6-visualizing-movement.tex}
    \input{content/2-literature-review/7-data-visualization-cultural-heritage.tex}
    \input{content/2-literature-review/8-representing-artists-life.tex}
    \clearpage
    \input{content/2-literature-review/9-strengths-weaknesses-stc.tex}

    \chapter{Background}\label{ch:background}
    \input{content/4-background/0-intro.tex}
    \clearpage
    \input{content/4-background/1-angular.tex}
    \input{content/4-background/2-three.js.tex}
    \input{content/4-background/3-webXR.tex}
    \input{content/4-background/4-spring-framework.tex}

    \chapter{Concept and Implementation}\label{ch:implementation}
    \input{content/3-implementation/0-intro.tex}
    \input{content/3-implementation/1-general-overview.tex}
    \input{content/3-implementation/2-homepage.tex}
    \input{content/3-implementation/3-managing-cities.tex}
    \input{content/3-implementation/4-managing-artists.tex}
    \input{content/3-implementation/5-managing-exhibitions.tex}
    \input{content/3-implementation/6-managing-historic-events.tex}
    \input{content/3-implementation/7-space-time-cube.tex}
    \input{content/3-implementation/8-ar-prototype.tex}
    \input{content/3-implementation/9-specifics-backend-implementation.tex}

    \chapter{Evaluation}\label{ch:evaluation}
    \input{content/5-evaluation/0-intro.tex}

    \chapter{Conclusion}\label{ch:conclusion}
    \input{content/6-conclusion/0-intro.tex}
    \input{content/6-conclusion/1-future-work.tex}

    \appendix
    \chapter{Detailed Database Structure}\label{ch:database-structure}
    \input{content/7-appendix/A-appendix.tex}
    \chapter{Code Examples}\label{ch:code-examples}
    \input{content/7-appendix/B-appendix.tex}
